...
export class EventComponent {
  events: Event[] = [
    ...
    },
    {
      ...
      price: '35€ / personne',
      description:
        'For an axe throwing party, you’ll get private lanes, coaching from an experienced instructor, and organized games and tournaments. Safety is a priority, with no accidents since inception. The event promises a fun, memorable experience with photos and team-building opportunities.',
      imageUrl: 'assets/privatisation_400_320.png',
    },
  ];
